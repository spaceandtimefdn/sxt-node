/// Implements functions that interpret sqlparser types as proof-of-sql types as SxT chain expects.
///
/// Creates..
/// - `UnsupportedColumnType`
/// - `sqlparser_data_type_to_proof_of_sql_column_type`
#[macro_export]
macro_rules! impl_sqlparser_proof_of_sql_type_conversion {
    () => {
        ...
        pub enum UnsupportedColumnType {
            ...
            #[snafu(display(
                "decimal precision should be between 1 and 75, received: {precision}"
            ))]
            DecimalPrecision {
        ...
        fn sqlparser_number_info_to_proof_of_sql_precision_and_scale(
            number_info: &sqlparser::ast::ExactNumberInfo,
        ) -> Result<(proof_of_sql::base::math::decimal::Precision, i8), UnsupportedColumnType> {
            ...
            let scale =
                i8::try_from(scale).map_err(|_| UnsupportedColumnType::DecimalScale { scale })?;
        ...
        pub fn sqlparser_data_type_to_proof_of_sql_column_type(
            sqlparser_type: &sqlparser::ast::DataType,
        ) -> Result<proof_of_sql::base::database::ColumnType, UnsupportedColumnType> {
...
#[cfg(test)]
mod tests {
    impl_sqlparser_proof_of_sql_type_conversion!();
