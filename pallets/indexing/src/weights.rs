...
//! HOSTNAME: `system-76`, CPU: `13th Gen Intel(R) Core(TM) i9-13900H`
//! WASM-EXECUTION: `Compiled`, CHAIN: `None`, DB CACHE: 1024

// Executed Command:
// /mnt/target/release/sxt-node
// benchmark
// pallet
// --pallet
// pallet_indexing
...
pub trait WeightInfo {
    ...
    /// Proof: `Indexing::Submissions` (`max_values`: None, `max_size`: Some(1126), added: 3601, mode: `MaxEncodedLen`)
    /// Storage: `Commitments::CommitmentStorageMap` (r:2 w:0)
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn submit_data_quorum_reached() -> Weight {
        ...
        //  Measured:  `8014`
        //  Estimated: `96934`
        // Minimum execution time: 353_555_737_000 picoseconds.
        Weight::from_parts(359_070_760_000, 0)
